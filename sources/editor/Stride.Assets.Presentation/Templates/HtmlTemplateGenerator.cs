...
{
    public class HtmlTemplateGenerator : AssetTemplateGenerator
    {
        private const string AssetTypeName = "HtmlFileAsset";

        public static readonly HtmlTemplateGenerator Default = new HtmlTemplateGenerator();

        private static readonly PropertyKey<string> ClassNameKey = new PropertyKey<string>("ClassNameKey", typeof(HtmlTemplateGenerator));

        private static readonly PropertyKey<string> DefaultClassNameKey = new PropertyKey<string>(nameof(DefaultClassNameKey), typeof(HtmlTemplateGenerator));

        private static readonly PropertyKey<bool> EnableTemplateSelectKey = new PropertyKey<bool>(nameof(EnableTemplateSelectKey), typeof(HtmlTemplateGenerator));

        private static readonly PropertyKey<bool> SaveSessionKey = new PropertyKey<bool>("SaveSessionKey", typeof(HtmlTemplateGenerator));
